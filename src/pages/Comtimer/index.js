...
export default function Comtimer(props) {
  ...
  function loadContador(maxi, mini) {
    ...
    let fimContador = 0;
    if (exercicio_id === 178 || exercicio_id === 179) fimContador = 5;
    if (
      exercicio_id === 180 ||
      exercicio_id === 181 ||
      exercicio_id === 182 ||
      ...
      fimContador = 10;
    if (exercicio_id === 184) fimContador = 8;
    if (exercicio_id === 185) fimContador = 5;
